...
ethnicity <- read_excel("2018_JD_Enrollment_and_Ethnicity-2.xlsx") %>% 
  ...
  mutate(percent_race_unknown = (race_unk_jd_degrees_awd / total_degrees_awarded)*100) %>% 
...
ethnicity_test <- read_excel("2018_JD_Enrollment_and_Ethnicity-2.xlsx") %>% 
  ...
  gather(percent_minority, percent_white, percent_race_unknown, percent_international, key = "label", value = "percent") 

ethnicity_test_2 <- left_join(first_year, ethnicity_test, by = "school_name")
...
ethnicity_test_2 %>% 
  ...
  # scale_y_continuous(breaks = scales::pretty_breaks(n = 10)) +
    ...
    labs(x = NULL,
       y = "Percent",
       title = "Ethnicity of Most Recent Graduating Class") +
